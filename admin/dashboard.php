            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        ...
                        <span class="stat-label">Asesmen</span>
                    </div>
                </div>
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        <span class="stat-value">0</span>
                        <span class="stat-label">Kasus Burnout</span>
                    </div>
                </div>
            </div>

            <h2 class="action-title">Akses Cepat</h2>
            <div class="actions-grid">
                <a href="admin_knowledge.php" class="action-card">
                    <span class="action-card__icon">📚</span>
                    <span class="action-card__name">Kelola Gejala</span>
                    <span class="action-card__desc">Update basis pengetahuan dan gejala burnout.</span>
                </a>
                <a href="admin_knowledge.php" class="action-card">
                    <span class="action-card__icon">🧠</span>
                    <span class="action-card__name">Kelola Aturan BC</span>
                    <span class="action-card__desc">Atur logika Backward Chaining sistem pakar.</span>
                </a>
                <a href="#" class="action-card">
                    <span class="action-card__icon">📊</span>
                    <span class="action-card__name">Lihat Laporan</span>
                    <span class="action-card__desc">Pantau statistik dan hasil deteksi pengguna.</span>
                </a>
            </div>
        </main>
    </div>
