...
<div class="main-wrapper">
    <?php 
        ...
        ob_start(); ?>
        <button class="btn-export" onclick="this.classList.add('btn-loading'); setTimeout(() => { this.classList.remove('btn-loading'); window.print(); }, 800)" style="background:var(--color-primary); color:#fff; border:none; padding:0.6rem 1.25rem; border-radius:10px; font-weight:700; display:flex; align-items:center; gap:0.6rem; cursor:pointer; font-size:0.875rem;">
