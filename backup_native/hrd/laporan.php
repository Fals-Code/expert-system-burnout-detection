...
<div class="main-wrapper">
    <?php 
        ...
        <div class="topbar__actions" style="display:flex; gap:0.75rem; align-items:center;">
            <button class="btn-print" style="background:#28A745;" onclick="this.classList.add('btn-loading'); setTimeout(() => { this.classList.remove('btn-loading'); exportTableToCSV('laporan_burnout_mei2026.csv'); }, 800)">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                <span>Excel</span>
            </button>
            <button class="btn-print" onclick="this.classList.add('btn-loading'); setTimeout(() => { this.classList.remove('btn-loading'); window.print(); }, 800)">
