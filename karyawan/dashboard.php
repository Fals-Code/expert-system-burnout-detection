...
<head>
    ...
    <style>
        ...
        .sidebar {
            width: 260px;
            min-height: 100vh;
            background: linear-gradient(180deg, #0D1F36 0%, var(--color-primary) 60%, #2A5080 100%);
            display: flex;
        ...
        .sidebar-brand__icon svg { color: var(--color-accent); }
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="dashboard.php" class="nav-item <?= $active_menu === 'dashboard' ? 'active' : '' ?>" id="nav-dashboard">
        ...
        <a href="deteksi.php" class="nav-item <?= $active_menu === 'deteksi' ? 'active' : '' ?>" id="nav-deteksi">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <a href="riwayat.php" class="nav-item <?= $active_menu === 'riwayat' ? 'active' : '' ?>" id="nav-riwayat">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <path d="M12 8v4l3 3"/>
        ...
        <a href="profil.php" class="nav-item <?= $active_menu === 'profil' ? 'active' : '' ?>" id="nav-profil">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
