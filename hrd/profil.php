...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'update_profile') {
        ...
        if (empty($new_nama)) {
            ...
            unset($u);
            append_log($new_nama, 'UPDATE_PROFILE', $user['id'], "Memperbarui profil mandiri (HRD).");
        ...
        if (!password_verify($old_pw, $user['password'])) {
            ...
            append_log($user['nama'], 'UPDATE_PASSWORD', $user['id'], "Mengubah password akun (HRD).");
